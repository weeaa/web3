...
func TestDecodeTxData(t *testing.T) {
	...
	if result["sharesSubject"].(common.Address) != common.HexToAddress("0x9Fc2473E4D5451B0a99244033D46902aE3AbBD71") {
		assert.Error(t, fmt.Errorf("expected 0x9Fc2473E4D5451B0a99244033D46902aE3AbBD71"))
	}
